...
def admin_options():
    ...
    admin_options_window.configure(bg="#153141")
    ...
    new_product_button = tk.Button(admin_options_window, text="Add New Product", command=add_new_product,
                                   bg="lightgreen", fg="black", font=("Helvetica", 16, "bold"), relief="flat")
    new_product_button.pack(pady=10)
    new_product_button.bind("<Enter>", lambda e: e.widget.config(bg="darkgreen"))
    new_product_button.bind("<Leave>", lambda e: e.widget.config(bg="lightgreen"))
    ...
    change_password_button.bind("<Enter>", lambda e: e.widget.config(bg="darkgreen"))
    change_password_button.bind("<Leave>", lambda e: e.widget.config(bg="lightgreen"))
...
def customer_login(fullscreen_window):
    fullscreen_window.configure(bg="#153141")
    while True:
...
def display_gui():
    ...
    admin_button = tk.Button(root, text="Admin", command=admin_login, bg="lightgreen", fg="black", font=("Helvetica", 16, "bold"), relief="flat")
    admin_button.pack(pady=100)
    admin_button.bind("<Enter>", lambda e: e.widget.config(bg="darkgreen"))
    admin_button.bind("<Leave>", lambda e: e.widget.config(bg="lightgreen"))
    
    customer_button = tk.Button(root, text="Customer", command=lambda: start_customer_login(root), bg="lightgreen", fg="black", font=("Helvetica", 16, "bold"), relief="flat")
    customer_button.pack(pady=50)
    customer_button.bind("<Enter>", lambda e: e.widget.config(bg="darkgreen"))
    customer_button.bind("<Leave>", lambda e: e.widget.config(bg="lightgreen"))
